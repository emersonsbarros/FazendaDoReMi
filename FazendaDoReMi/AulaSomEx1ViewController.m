...
//Animados
    ...
    [[ControladorDeItem sharedManager]retornaItem :@"xilofone"  :self.imgXilofone:  @"gestureTap:1:1 + 1 + 2:0:1 + 7:xilofoneTocando:5:YES:YES:0"];
    ...
    [[ControladorDeItem sharedManager]retornaItem :@"violao"    :self.imgViolao:    @"gestureTap:1:1 + 1 + 2:0:1 + 3:5.0:5.0:1.0:1.5"];
