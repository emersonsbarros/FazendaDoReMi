...
-(void)criaCasa {
    ...
    SKTexture *texturaPiso = [SKTexture textureWithImageNamed:@"spriteCasa.png"];
...
-(void)criaMascote{
    ...
    SKTexture *texturaPiso2 = [SKTexture textureWithImageNamed:@"zecaoSpriteVoando.png"];
    self.man = [SKSpriteNode spriteNodeWithTexture:texturaPiso2 size:CGSizeMake(100,150)];
    ...
    self.humanoFrames = [self loadSpriteSheetFromImageWithName:@"zecaoSpriteVoando.png" withNumberOfSprites:7 withNumberOfRows:1 withNumberOfSpritesPerRow:7];
